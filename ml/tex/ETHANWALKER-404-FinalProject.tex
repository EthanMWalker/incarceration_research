...
\texttt{param\_grid\ =\ \{\ \ \ \ \ \textquotesingle{}learning\_rate\textquotesingle{}:\ np.linspace(.01,1,10),\ \ \ \ \ \textquotesingle{}subsample\textquotesingle{}:\ np.linspace(.05,1,10)\ \}}

I found the following parameters

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor} }]:} \PY{k}{with} \PY{n+nb}{open}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{./pickles/GradientBoostedClf1.pickle}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{rb}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)} \PY{k}{as} \PY{n}{f}\PY{p}{:}
            \PY{n}{clf} \PY{o}{=} \PY{n}{pickle}\PY{o}{.}\PY{n}{load}\PY{p}{(}\PY{n}{f}\PY{p}{)}
            \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Max Depth = }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{clf}\PY{o}{.}\PY{n}{get\PYZus{}params}\PY{p}{(}\PY{p}{)}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{max\PYZus{}depth}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
            \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Number of Estimators = }\PY{l+s+si}{\PYZob{}\PYZcb{}}\PY{l+s+s1}{.}\PY{l+s+s1}{\PYZsq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{clf}\PY{o}{.}\PY{n}{get\PYZus{}params}\PY{p}{(}\PY{p}{)}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{n\PYZus{}estimators}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
\texttt{param\_grid\ =\ \{\ \ \ \ \ \textquotesingle{}reg\_alpha\textquotesingle{}:np.linspace(.01,1,10),\ \ \ \ \ \textquotesingle{}reg\_lambda\textquotesingle{}:np.linspace(.01,1,10),\ \ \ \ \ \textquotesingle{}gamma\textquotesingle{}:np.linspace(.01,1,10)\ \}}
...
\texttt{param\_grid\ =\ \{\ \ \ \ \ \textquotesingle{}boosting\_type\textquotesingle{}:\ {[}\textquotesingle{}gbdt\textquotesingle{},\textquotesingle{}dart\textquotesingle{},\textquotesingle{}goss\textquotesingle{}{]},\ \ \ \ \ \textquotesingle{}learning\_rate\textquotesingle{}:\ np.linspace(.01,1,10),\ \ \ \ \ \textquotesingle{}n\_estimators\textquotesingle{}:\ np.arange(100,1100,100),\ \ \ \ \ \textquotesingle{}max\_depth\textquotesingle{}:\ np.arange(0,10)\ \}}
